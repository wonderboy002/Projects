    ...
    <div className="w-full Header bg-red-500 flex flex-col text-white p-8 h-[450px]">
      ...
      <div className="punchline  my-auto flex flex-col gap-6 mx-auto">
        ...
        <div className="buttons mx-auto flex gap-4">
          <Link
            className="signup p-4 rounded-xl transition-all hover:bg-black hover:scale-95"
            to="/Signup"
          >
            Sign up
          </Link>
          <Link
            className="login p-4 roundex-xl transition-all hover:bg-white hover:rounded-xl hover:text-black hover:scale-95"
            to="/Login"
          >
            Login
          </Link>
